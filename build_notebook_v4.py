...
cells_content = [
    ...
    [
        "# CELL 9: 🔊 TEXT TO SPEECH (BENGALI OUTPUT API - V4 ROBUST FIX)\n",
        ...
        "\n",
        "    # 🔥 FIX 1: Fetch valid voice automatically using your exact API key\n",
        ...
        "\n",
        "    # 🔥 FIX 4: Use exact standard headers\n",
        "    headers_post = {\n",
        "        \"Accept\": \"audio/mpeg\",\n",
    ...
    [
        ...
        ")\n",
        "\n",
        "# ✅ Ensure queue engine forces synchronization across single loop \n",
    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# 🚀 ClaimGuard AI V4 (Elevenlabs Robust Drop-In Fix)\n",
...
with open(r"c:\Users\raj17\Desktop\ClaimGuard AI\ClaimGuard_AI_Kaggle_v4.ipynb", "w", encoding="utf-8") as f:
