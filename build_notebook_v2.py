...
cells_content = [
    [
        ...
        "# ==============================================================================\n",
        "\n",
        "# Install Python packages (REMOVED faiss-gpu)\n",
    ...
    [
        "# ==============================================================================\n",
        "# CELL 3: Imports & Configuration (FIXED)\n",
        "# ==============================================================================\n",
        "\n",
        "import os\n",
        ...
        "import nest_asyncio\n",
        "\n",
        "# FIX GRADIO EVENT LOOP CRASH IN JUPYTER\n",
        "nest_asyncio.apply()\n",
        "\n",
    ...
    [
        ...
        "    # 1. Input Processing & Caching logic\n",
        ...
        "    return format_elite_report(audit)"
    ],
    [
        "# CELL 10: AUTOMATED TEST CASE & UI\n",
        ...
        "print(\"=\"*50)\n",
        "test_output = run_claim_analysis(\"sample_policy.pdf\", \"Accident surgery tomorrow costing 50000 at Apollo\")\n",
        "print(\"\\n\" + test_output)\n",
        "print(\"=\"*50 + \"\\n\")\n",
        "\n",
        ...
        "    ],\n",
        "    outputs=gr.Markdown(label=\"🛡️ Elite Risk Analyst Report\"),\n",
        ...
        "\n",
        "# Launch Interface\n",
        "interface.launch(share=True, quiet=False)"
    ]
]
    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# 🚀 ClaimGuard AI (Fixed & Optimized for Kaggle)\n",
                "Execute the cells below in sequential order. Cell 1, 2, and 3 incorporate Kaggle CPU/networking stability fixes."
            ]
        }
    ],
    "metadata": {
...
with open(r"c:\Users\raj17\Desktop\ClaimGuard AI\ClaimGuard_AI_Kaggle_v2.ipynb", "w", encoding="utf-8") as f:
