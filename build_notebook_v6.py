...
cells_content = [
    [
        "# ==============================================================================\n",
        "# CELL 1: Install Dependencies (FINAL FIX)\n",
        "# ==============================================================================\n",
        "\n",
        "# Install Python packages (REMOVED nest-asyncio as it breaks Uvicorn on Python 3.11+)\n",
    ...
    [
        "# CELL 9: 🌍 SIMPLE TRANSLATIONS (HINDI & BENGALI TEXT)\n",
        "def generate_simple_translations(english_report):\n",
        "    print(\"🌍 Translating to simple Hindi & Bengali using Llama 3...\")\n",
        "    \n",
        "    base_sys_prompt = \"You are a helpful, empathetic assistant translating insurance reports into very simple, everyday language for older generations. Avoid complex jargon. Just clearly state the final payout, what was deducted, and the biggest risks.\"\n",
        "    \n",
        "    hindi_prompt = f\"Summarize and translate this report into VERY SIMPLE Hindi, so an elderly person can understand exactly what they need to know:\\n\\n{english_report}\\n\\nOutput STRICTLY the simple Hindi text.\"\n",
        "    \n",
        "    bengali_prompt = f\"Summarize and translate this report into VERY SIMPLE Bengali, so an elderly person can understand exactly what they need to know:\\n\\n{english_report}\\n\\nOutput STRICTLY the simple Bengali text.\"\n",
        "    \n",
        "    hindi_translation = call_ollama(hindi_prompt, system_prompt=base_sys_prompt, json_format=False).strip()\n",
        "    if not hindi_translation:\n",
        "        hindi_translation = \"माफ़ करें, मैं इस समय अनुवाद नहीं कर सकता। अपनी पॉलिसी चेक करें।\"\n",
        "        \n",
        ...
        "        bengali_translation = \"দুঃখিত, আমি এই মুহূর্তে অনুবাদ করতে পারছি না। আপনার পলিসি চেক করুন।\"\n",
        "        \n",
        "    print(\"✅ Text Translations completed successfully!\")\n",
    ...
    [
        ...
        "\n",
        "    # 4. Generate Simple Translations\n",
        "    hindi_text, bengali_text = generate_simple_translations(report)\n",
        "    \n",
        "    return report, hindi_text, bengali_text"
    ],
    [
        "# CELL 11: AUTOMATED TEST CASE & UI\n",
        "import warnings\n",
        "warnings.filterwarnings('ignore') # Suppress gradio theme warnings\n",
        "\n",
        ...
        "print(\"=\"*50)\n",
        "test_report, test_hindi, test_bengali = run_claim_analysis(\"sample_policy.pdf\", \"Accident surgery tomorrow costing 50000 at Apollo\")\n",
        "print(\"\\n\" + test_report)\n",
        "print(\"\\n=== HINDI (Simple) ===\\n\" + test_hindi)\n",
        "print(\"\\n=== BENGALI (Simple) ===\\n\" + test_bengali)\n",
        "print(\"=\"*50 + \"\\n\")\n",
        "\n",
        "# ✅ NO ASYNC HANDLERS. Fully sync file wrapper bypassing concurrency.\n",
        "def gradio_wrapper(pdf, query):\n",
        "    if not pdf or not query: return \"⚠️ Please upload a PDF and specify a scenario.\", \"\", \"\"\n",
        "    try:\n",
        ...
        "        gr.Markdown(label=\"🇮🇳 आसान हिंदी अनुवाद (Simple Hindi)\"),\n",
        "        gr.Markdown(label=\"🇧🇩 সহজ বাংলা অনুবাদ (Simple Bengali)\")\n",
        "    ],\n",
    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# 🚀 ClaimGuard AI V6 (Simple Text Translations & Stable Launch)\n",
                "Removed TTS overhead. Added layman explanation layers in local languages."
            ]
        }
    ],
    "metadata": {
...
with open(r"c:\Users\raj17\Desktop\ClaimGuard AI\ClaimGuard_AI_Kaggle_v6.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print("Notebook v6 generated successfully!")
