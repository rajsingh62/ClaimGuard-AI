...
cells_content = [
    ...
    [
        ...
        "\n",
        "# ✅ FIX: Completely removed nest_asyncio. It causes Uvicorn/FastAPI runtime panics on newer Python 3.12 environments in Kaggle.\n",
        "\n",
        "import io\n",
        "import re\n",
        "import json\n",
    ...
    [
        ...
        "def generate_bengali_audio(english_report, output_path=\"bengali_report_summary.mp3\"):\n",
        ...
        "        bengali_translation = \"অনুগ্রহ করে আপনার পলিসি চেক করুন এবং আরও যাচাইকরণের জন্য অপেক্ষা করুন।\" \n",
        "        \n",
        "    bengali_translation = bengali_translation.encode(\"utf-8\").decode(\"utf-8\")\n",
        "    bengali_translation = bengali_translation[:2000]\n",
        "\n",
        ...
        "    except Exception as e:\n",
        "        print(f\"❌ Voice fetch failed (Check API Key). Error: {e}\")\n",
        "        return None\n",
        "\n",
    ...
    [
        ...
        ")\n",
        "\n",
        "# ✅ FIXED: Removed .queue() resolving gradio's lock collision without breaking Uvicorn thread factories.\n",
        "# ✅ FIXED: Removed debug=True preventing single thread starvation.\n",
    ...
    "cells": [
        {
            ...
            "metadata": {},
            "source": [
                "# 🚀 ClaimGuard AI V5 (The Ultimate Crash-Free Pipeline)\n",
...
with open(r"c:\Users\raj17\Desktop\ClaimGuard AI\ClaimGuard_AI_Kaggle_v5.ipynb", "w", encoding="utf-8") as f:
