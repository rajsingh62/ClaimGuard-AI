...
cells_content = [
    ...
    # === CELL 3: Engine Module (OCR + AI + All Functions) ===
    [
        "# ================================================================\n",
    ...
    # === CELL 4: Flask API Server with ngrok ===
    [
        "# ================================================================\n",
...
output_path = r"c:\Users\raj17\Desktop\ClaimGuard AI\ClaimGuard_AI_Kaggle_API_Server.ipynb"
with open(output_path, "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print(f"[OK] Kaggle API Server notebook generated: {output_path}")
